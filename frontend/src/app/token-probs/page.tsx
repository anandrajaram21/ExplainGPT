    ...
    <PageContainer>
      <div className="space-y-1 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Enter a prompt below to see how the AI model predicts each token with
          confidence scores
        </p>
      </div>
          ...
          <form onSubmit={handleSubmitPrompt} className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                The model will generate token probabilities based on this input
                text
              </p>
            </div>
          </form>
              ...
              <div className="p-12 text-center">
                <div className="max-w-md mx-auto space-y-4">
                  ...
                  <p className="text-muted-foreground text-lg">
                    Enter a prompt above and click "Generate" to visualize token
                    probabilities
                  </p>
                </div>
              </div>
