...
def head_view(attention, tokens):
    ...
    html1 = """'<script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.6/require.min.js"></script>'"""

    html2 = vis_html

    vis_js = head_view_js.replace('PYTHON_PARAMS', json.dumps(params))
    html3 = f'<script type="text/javascript">{vis_js}</script>'
